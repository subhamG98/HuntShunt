        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    HttpPost httpPost = new HttpPost("http://resolvefinance.co.uk/Whatsapp/message_noti.php");
            ...
            public void onPostExecute(String result) {
                try {
                    ...
                    if (result.contains("<") || result == null) {
                        ...
                        if (chat_page1.chat_flag == 1&& result!="") {
                        ...
                        notification.setLatestEventInfo(getBaseContext(), "HuntShunt-New message received" , "" + result + "sent you a new message", pendingIntent);
