...
View v;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v= inflater.inflate(R.layout.fragment_recyclerview1, container, false);
    ...
    private void getData1(){
        class GetData extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    URL url = new URL("http://resolvefinance.co.uk/Whatsapp/friendlist.php?username="+SplashScreen.username1+"&lati="+SplashScreen.latitude+"&longi="+SplashScreen.longitude);
                    Log.i("okcheckit23", "http://resolvefinance.co.uk/Whatsapp/friendlist.php?username="+SplashScreen.username1+"&lati="+SplashScreen.latitude+"&longi="+SplashScreen.longitude);
