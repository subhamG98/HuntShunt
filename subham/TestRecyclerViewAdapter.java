...
public class TestRecyclerViewAdapter extends RecyclerView.Adapter<TestRecyclerViewAdapter.ViewHolder> {
  ...
  public static String headerphoto="";
    ...
    public TestRecyclerViewAdapter(Activity context, String[] title_friend, String[] fullname,String[] sex, String[] distance,String[] type,String[] image) {
        super();
    ...
    public int getItemViewType(int position) {
        ...
        switch (position) {
            ...
            default:
                ...
                if(list.getType().equals("promo")||list.getType().equals("promochat")){
                    Log.i("promotohai", "" + list.getType());
                    return TYPE_CELL1;
                }else{
                return TYPE_CELL;}
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_CELL: {
                ...
                def = (RelativeLayout) v.findViewById(R.id.grgg1);
                trimCache(context);
    ...
    @Override
    public void onBindViewHolder(TestRecyclerViewAdapter.ViewHolder holder, final int position) {
                ...
                Picasso.with(context).load("http://resolvefinance.co.uk/Whatsapp/uploads/" +list.getSex() + ".png").resize(50,50).into(holder.sex);
                    ...
                    def.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ListClass list2 =  items.get(position);
                            clicked_on_username = list2.getTitle_friend();
                            clicked_on_name = list2.getFullname();
